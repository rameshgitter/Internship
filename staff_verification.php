    ...
    if (isset($_POST['verify_registration'])) {
        ...
        try {
            ...
            $stmt = $pdo->prepare("
                ...
                WHERE id = ?
            ");
            $stmt->execute([$status, $staff_id, $notes, $registration_id]);
            ...
            $stmt = $pdo->prepare("
                ...
                VALUES (?, 'registration', ?, ?, ?)
            ");
            $stmt->execute([$registration_id, $staff_id, $notes, $status]);
...
// Get pending registrations assigned to this staff or unassigned
        ...
        <div class="row">
            ...
            <nav class="col-md-3 col-lg-2 sidebar">
                ...
                <div class="nav flex-column">
                    ...
                    <a class="nav-link active" href="staff_verification.php">
