...
CREATE TABLE student_info (
    ...
    guardian_mobile_no INT(10) NOT NULL,
...
-- 8. Staff/Employee table (for professors and staff)
CREATE TABLE staff_info (
    id INT(10) PRIMARY KEY AUTO_INCREMENT,
    staff_id VARCHAR(30),
    staff_type VARCHAR(20) NOT NULL, -- Professor, Staff, etc.
    department_id VARCHAR(5),
    first_name VARCHAR(20) NOT NULL,
    middle_name VARCHAR(20),
    last_name VARCHAR(20),
...
('STAFF001', 'Staff', 'CSE', 'Amit', 'Singh', 'Administrative Staff', 9876543212, 'amit.singh@iiests.ac.in', '2019-03-15');
