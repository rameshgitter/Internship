...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_verification'])) {
    ...
    try {
        ...
        $stmt->execute([$status, $remarks, $verification_id, $staff_id]);
...
// Get verification assignments for this staff
...
");
$verifications->execute([$staff_id]);
...
$all_staff = $pdo->query("SELECT * FROM staff_info ORDER BY staff_id")->fetchAll();
?>
        ...
        <div class="row">
            ...
            <nav class="col-md-3 col-lg-2 sidebar">
                ...
                <div class="nav flex-column">
                    ...
                    <a class="nav-link" href="#verifications" onclick="showSection('verifications')">
                        <i class="fas fa-check-circle"></i> My Verifications
                    </a>
            ...
            <main class="col-md-9 col-lg-10 main-content">
                ...
                <div class="row mb-4">
                    <div class="col">
                        ...
                        <p class="text-muted">Staff ID: <?= htmlspecialchars($staff['staff_id']) ?></p>
                        <?php if ($success): ?>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <p><strong>Department:</strong> <?= htmlspecialchars($staff['department_id']) ?></p>
                                </div>
                                <div class="col-md-6">
                                    <p><strong>Designation:</strong> <?= htmlspecialchars($staff['designation']) ?></p>
                                    <p><strong>Email:</strong> <?= htmlspecialchars($staff['email']) ?></p>
                                    <p><strong>Mobile:</strong> <?= htmlspecialchars($staff['mobile_no']) ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
